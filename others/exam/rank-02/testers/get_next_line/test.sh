cp ../../my_code/get_next_line/get_next_line.c .
cp ../../my_code/get_next_line/get_next_line.h .
...
rm -rf original.res yours_.res yours.res get_next_line get_next_line.c get_next_line.h
